...
public class FlowTemplateDetailPO implements Serializable {
    ...
    public FlowTemplateDetailPO withFlowName(String flowName) {
    ...
    public FlowTemplateDetailPO withSortNo(Short sortNo) {
    ...
    public FlowTemplateDetailPO withDependTask(String dependTask) {
    ...
    public FlowTemplateDetailPO withTaskName(String taskName) {
    ...
    public FlowTemplateDetailPO withTaskTypeName(String taskTypeName) {
    ...
    public FlowTemplateDetailPO withIsRun(Short isRun) {
        this.setIsRun(isRun);
        return this;
    }
    ...
    public FlowTemplateDetailPO withIsSkip(Short isSkip) {
    ...
    public FlowTemplateDetailPO withDusList(String dusList) {
    ...
    public FlowTemplateDetailPO withServiceList(String serviceList) {
    ...
    public FlowTemplateDetailPO withTaskType(String taskType) {
    ...
    public FlowTemplateDetailPO withRetryTime(Short retryTime) {
    ...
    public FlowTemplateDetailPO withDescription(String description) {
    ...
    public FlowTemplateDetailPO withLastModStamp(LocalDateTime lastModStamp) {
    ...
    public FlowTemplateDetailPO withCreateStamp(LocalDateTime createStamp) {
