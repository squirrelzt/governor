...
public class SimpleTaskTemplate implements Serializable {
    ...
    public SimpleTaskTemplate withJobName(String jobName) {
    ...
    public SimpleTaskTemplate withTaskTypeName(String taskTypeName) {
    ...
    public SimpleTaskTemplate withJobType(String jobType) {
    ...
    public SimpleTaskTemplate withDusList(String dusList) {
    ...
    public SimpleTaskTemplate withServiceList(String serviceList) {
    ...
    public SimpleTaskTemplate withDescription(String description) {
    ...
    public SimpleTaskTemplate withLastModStamp(LocalDateTime lastModStamp) {
    ...
    public SimpleTaskTemplate withCreateStamp(LocalDateTime createStamp) {
    ...
    public SimpleTaskTemplate withJobProcessor(String jobProcessor) {
