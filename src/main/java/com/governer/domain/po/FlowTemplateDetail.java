...
public class FlowTemplateDetail implements Serializable {
    ...
    public FlowTemplateDetail withFlowName(String flowName) {
    ...
    public FlowTemplateDetail withSortNo(Short sortNo) {
    ...
    public FlowTemplateDetail withDependTask(String dependTask) {
    ...
    public FlowTemplateDetail withTaskName(String taskName) {
    ...
    public FlowTemplateDetail withTaskTypeName(String taskTypeName) {
    ...
    public FlowTemplateDetail withIsRun(Short isRun) {
        this.setIsRun(isRun);
        return this;
    }
    ...
    public FlowTemplateDetail withIsSkip(Short isSkip) {
    ...
    public FlowTemplateDetail withDusList(String dusList) {
    ...
    public FlowTemplateDetail withServiceList(String serviceList) {
    ...
    public FlowTemplateDetail withTaskType(String taskType) {
    ...
    public FlowTemplateDetail withRetryTime(Short retryTime) {
    ...
    public FlowTemplateDetail withDescription(String description) {
    ...
    public FlowTemplateDetail withLastModStamp(LocalDateTime lastModStamp) {
    ...
    public FlowTemplateDetail withCreateStamp(LocalDateTime createStamp) {
